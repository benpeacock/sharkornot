...
function sharkTest() {
	...
	if ($rand == 1) {
		$choice = download();
		$message = '<strong class="inverted">Congratulations,</strong>
						<br />you\'re a shark!
						<hr />
						Download your Badge of Sharkularity:
						<br />
						<a href="' . $choice . '" class="btn btn-primary btn-custom2">Get Badge</a> <span class="arrow hlb hidden-phone" style="margin-top:25px"></span>';
	} else if ($rand == 0) {
		$message = '<strong class="inverted">Sorry,</strong><br /> you\'re not a shark.<br /><a href="test.php" class="btn btn-primary btn-custom2">Try Again</a> <span class="arrow hlb hidden-phone" style="margin-top:25px"></span>';
	} else {
								...
								<div class="form">
									<form action="test.php" method="post">
										<ul class="fields">
											...
											<li class="fields">
												<input type="submit" class="btn btn-primary btn-custom" value="Begin Test" />
											</li>
										</ul>
									</form>
								</div>
